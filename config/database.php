...
return [
    ...
    |--------------------------------------------------------------------------
    */
    'default' => env('DB_CONNECTION', 'mysql'), // set default to master
    ...
    */
    'connections' => [
        ...
        'slave' => [
            ...
            'database' => env('DB_SLAVE_DATABASE', 'slave_db'),
        ...
        // Other default connections (pgsql, sqlsrv, mariadb) remain unchanged
        'pgsql' => [
            'driver' => 'pgsql',
            'url' => env('DB_URL'),
